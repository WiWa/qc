...
stepsize = 0.022 # Step-forward matrices step size
...
### This part shows how the pulse shapes were graphed
...
### This part shows most of the modifications necessary
### to search through parameter space of pulse width
